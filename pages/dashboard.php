...
<div class="container">
    ...
    <button class="button is-danger deleteFolder" style="float: right;margin-right:20px;" type="button" ondrop="del(event, this)" ondragenter="preventDefaults(event)" ondragover="preventDefaults(event)">Slet fil</button>
    <div id="files">
    Loading..
    </div>
    </form>
